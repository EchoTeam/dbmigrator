ALTER TABLE Items ADD COLUMN ItemFlagsCount INT DEFAULT 0;

CREATE INDEX CONCURRENTLY IDX_Origin_ItemFlagsCount ON Items (ItemFlagsCount, ItemCreationTimestamp, ItemOriginURI, ItemState);

CREATE INDEX CONCURRENTLY IDX_Parent_ItemFlagsCount ON Items (ItemFlagsCount, ItemCreationTimestamp, ItemParentURI, ItemState);
